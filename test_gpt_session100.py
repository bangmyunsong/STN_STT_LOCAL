#!/usr/bin/env python3
"""
세션 100번 STT 전사 텍스트로 GPT API 테스트
"""

from gpt_extractor import ERPExtractor

def test_session100_gpt():
    print("🚀 세션 100번 STT 전사 텍스트 GPT API 테스트\n")
    ...
    try:
        ...
        result = extractor.extract_erp_data(session100_text, filename="session100_test")
...
if __name__ == "__main__":
    success = test_session100_gpt()
    if success:
        print("\n✅ GPT API 연결 및 ERP 추출 성공!")
    else:
        print("\n💥 GPT API 연결 또는 ERP 추출 실패!")
